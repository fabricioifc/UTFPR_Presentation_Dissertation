...
\begin{table}[!ht]
    ...
    \toprule
        ...
        \colorbox{yellow}{\textbf{Piscina}  & 51,3827} \\ 
        \textbf{Sombra}                     & 1,7031 \\ 
...
\begin{table}[!ht]
    ...
    \toprule
        ...
        \textbf{Piscina} & 0.18 & 0.89 & 0.30 & 0.17  \\ 
        ...
        \textbf{Água} & 0.45 & 0.06 & 0.11 & 0.05 \\ 
        \textbf{} & ~ & ~ & ~ & ~ \\ 
        \textbf{Acurácia} & 0.81 & ~ & IoU & 0.48 \\
        \bottomrule
        \addlinespace
    \end{tabular}
    \source{Autoria própria.}%% Fonte
...
\begin{table}[!ht]
    ...
    \toprule
        ...
        \textbf{Piscina}                    & 0.18 & \textbf{0.99} & 0.30 & 0.18  \\ 
        \textbf{Sombra}                     & 0.60 & \textbf{0.86} & 0.71 & 0.55  \\ 
        \textbf{Regeneração}                & \textbf{0.80} & 0.44 & 0.56 & 0.39  \\ 
        \textbf{Agricultura}                & 0.66 & 0.76 & 0.70 & 0.54  \\ 
        \textbf{Rocha}                      & 0.37 & \textbf{0.69} & 0.48 & 0.31  \\ 
        \textbf{Solo Exposto}               & 0.09 & \textbf{0.40} & 0.14 & 0.08  \\ 
        \textbf{Água}                       & \textbf{0.46} & \textbf{0.73} & \textbf{0.56} & \textbf{0.39} \\ 
        \textbf{} & ~ & ~ & ~ &  ~ \\ 
        \textbf{Acurácia} & 0.65 & ~ & IoU & 0.40 \\
        \bottomrule
        \addlinespace
    \end{tabular}
    \source{Autoria própria.}%% Fonte
